...
<div id="{{ $modal_id }}" class="w3-modal" style="z-index: 900;">
    <div class="w3-modal-content w3-animate-zoom w3-card-8">
        <header class="w3-container w3-purple">
            <span onclick="cancel('{{ $modal_id }}', '{{ $origin }}')" class="w3-closebtn"><i class="fa fa-close"></i></span>
        ...
        <div class="w3-container">
            ...
            <div class="w3-container">
                <form action="/edit_{{ $type }}" method="post">
                    ...
                    <input class="w3-input w3-hover-border-cyan" type="text" name="name" value="{{ $msg->username($msg->user_id) }}"  placeholder="您的暱稱" readonly>
